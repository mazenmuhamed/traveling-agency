...
export function BookingDialog({
  ...
  const [bookingDetails, setBookingDetails] = useState<z.infer<
    typeof formSchema
  > | null>(null)
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="h-screen max-w-screen overflow-y-auto rounded-2xl max-sm:rounded-none max-sm:px-4 sm:max-h-[90vh] sm:max-w-2xl">
        <DialogHeader>
